...
export declare class BarcodePickerCameraManager {
    ...
    private static readonly manualFocusRetryTimeoutMs;
    ...
    private manualFocusRetryTimeout;
    ...
    setUIOptions(enableCameraSwitcher: boolean, enableTorchToggle: boolean, enableTapToFocus: boolean): void;
